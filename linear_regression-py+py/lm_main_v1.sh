...
hadoop fs -put linear_random.csv /user/devel/2020210972bicheng

TASKNAME=linear_regression-py+py
# python location on hadoop
# PY27='/fli/tools/python2.7.tar.gz'
# hadoop client
# HADOOP_HOME=/home/users/fli/hadoop/bin/hadoop
HADOOP_INPUT_DIR=/user/devel/2020210972bicheng/linear_random.csv
...
-mapper "$PWD/lm_mapper_v1.py" \
-reducer "$PWD/lm_reducer_v1.py" \
-file "$PWD/lm_mapper_v1.py" "$PWD/lm_reducer_v1.py"
