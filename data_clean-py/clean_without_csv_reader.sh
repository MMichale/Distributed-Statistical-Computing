...
HADOOP_INPUT_DIR=/user/devel/2020210972bicheng/used_cars_data.csv
HADOOP_OUTPUT_DIR=/user/devel/2020210972bicheng/output_all_withoutcsv
...
-mapper "$PWD/clean_without_csv_reader.py" \
-file "$PWD/clean_without_csv_reader.py"
